...
/* Bài 486: Tính tích 2 don th?c
Mu?n nhân 2 don th?c ch?a h? s? và bi?n s?, ta nhân t?ng h? s? c?a các v? v?i nhau và nhân t?ng bi?n s? c?a các v? v?i nhau r?i ra dáp án
*/
...
/*
Bài 487: Tính d?o hàm c?p 1 don th?c
ax^n = n.ax^n - 1
*/
...
/*
Bài 488: Tính thuong 2 da th?c
Mu?n chia 2 don th?c ch?a h? s? và bi?n s?, ta chia t?ng h? s? c?a các v? v?i nhau và chia t?ng bi?n s? c?a các v? v?i nhau r?i ra dáp án
*/
...
/*
Bài 489: Tính d?o hàm c?p k c?a don th?c
don th?c ax^n
d?o hàm c?p 1: n.ax^n-1
d?o hàm c?p 2: n.n-1.ax^n-2 (d?o hàm c?a d?o hàm c?p 1)
d?o hàm c?p 3: n.n-1.n-2.ax^n-3 (d?o hàm c?a d?o hàm c?p 2)
*/
...
/*
Bài 490: Tính giá tr? don th?c t?i v? trí x = x0
y = ax^n 
thay x = x0 (ví d? x = 5)
=> y = a.5^n
*/
...
//491 Ð?nh nghia toán t? (operator *) cho 2 don th?c
...
//492 Ð?nh nghia toán t? (operator /) cho 2 don th?c
DONTHUC operator / (DONTHUC a, DONTHUC b)
{
	DonThuc c;
    c.HeSo = a.HeSo / b.HeSo;
